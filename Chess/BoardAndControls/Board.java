...
public class Board {
	public static void initialiseBoard(Piece[][] board) {
		...
		board[7][0] = new Rook(WHITE, 7, 0);          board[7][7] = new Rook(WHITE, 7, 7);        //White Rook

		board[0][1] = new Knight(BLACK, 0, 1);         board[0][6] = new Knight(BLACK, 0, 6);     //Black Knight
		board[7][1] = new Knight(WHITE, 7, 1);         board[7][6] = new Knight(WHITE, 7, 6);     //White Knight

		board[0][2] = new Bishop(BLACK, 0, 2);         board[0][5] = new Bishop(BLACK, 0, 5);     //Black Bishop
		board[7][2] = new Bishop(WHITE, 7, 2);         board[7][5] = new Bishop(WHITE, 7, 5);     //White Bishop

		board[0][3] = new Queen(BLACK, 0, 3);          board[7][3] = new Queen(WHITE, 7, 3);      //Queens
		board[0][4] = new King(BLACK, 0, 4);           board[7][4] = new King(WHITE, 7, 4);       //Kings
	}
